<?php
  ...
  $img_chitiet = isset($_REQUEST["img_chitiet"]) ? $_REQUEST["img_chitiet"] :"" ;
	...
	if($img == ""){ //nếu ảnh rổng thì k thực hiện $data["img"] = $img do khi thực hiện sẽ mất ảnh vì ảnh rỗng
  }else{
    $data["img"] = $img; 
  }
  if($img_chitiet == ""){ //nếu ảnh rổng thì k thực hiện $data["img"] = $img do khi thực hiện sẽ mất ảnh vì ảnh rỗng
  }else{
    $data["img_chitiet"] = $img_chitiet; 
  }
	$data["cid"] = $cid;
	$data["name"] = $name;
...
<body>
    ...
    <div class="notification-wrapper">
      <div class ="notification-main">
        <div class="notification-top">
          <span id = "notification-edit-click" class="btn-close-notifi" ><a href="#"><i class="fa-solid fa-square-xmark fa-lg" style="color: #ffc107;"></i></a></span>
        </div>
    ...
    <div class="header">
      ...
      <div class="header-center">
        ...
        <div class="header-center-responsive">
          <div class="logo-header-responsive"><img src="img/iconbe.png" alt="Lỗi" /></div>
          <div class="search-header-responsive">
    ...
    <div class="travel-edit-content">
      ...
      <div class="travel-content">
        ...
        <div class="travel-content-right">
          <div><span><a href="add_be.php">Thêm</a></span></div>
          <div><span ><a href="search_be.php">Tìm Kiếm</a></span></div>
        </div>
      </div>
			<div class="travel-edit-content-main">
          <form class="form" action="edit_exec_be.php" method="post" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?php echo $result["id"]?>"/>
            <label><b>Loại sản phẩm hiện tại:</b></label><label ><?php echo $result["cid"]?></label>
            <div class="clear-both"></div>
            <label><b>Loại sản phẩm:</b></label>
            <select name="cid">
              <option value="">Chọn loại sản phẩm</option>
              <?php foreach ($cates as $item) {?>
                <option value="<?php echo $item["id"]?>" <?php if ($item["id"] == $result["cid"]){?>selected<?php } ?>><?php echo $item["title"]?></option>
              <?php } ?>
            </select>	
            <div class="clear-both"></div>
            <label><b>Tên Sản Phẩm:</b></label><input name="name" value="<?php echo $result["name"]?>"/>
            <div class="clear-both"></div>
            <label><b>Price-new:</b></label><input name="price_new" value="<?php echo $result["price_new"]?>"/>
            <div class="clear-both"></div>
            <label><b>Descriptio:</b></label><textarea name="description"><?php echo $result["description"]?></textarea>
            <div class="clear-both"></div>
            <label><b>Xuất xứ:</b></label><input name="source" value="<?php echo $result["source"]?>"/>
            <div class="clear-both"></div>
            ...
            <div class="clear-both"></div>
            <label><b>Hình ảnh chi tiết:</b></label>

            <input name="img_chitiet" type="file" value="<?php echo $result["img_chitiet"]?>"/>
            <img src="<?php echo $result["img_chitiet"]?>"/>

            <div class="clear-both"></div>
            <button type="submit" class="btn btn-warning" id="btn_ctl_edit">Sửa</button>
            <a href="search_be.php"><button type="button" class="btn btn-warning" id="btn_ctl_edit">Bỏ qua</button></a>
          </form>
      </div>
		</div>
    <hr />
          ...
          <div class="container-fuild">
            <div class="row">
              ...
              <div class="col-6 col-md-3">
                ...
                <div class="img-footer-main">
                  <div class="img-footer"><a href="#"><img src="img/img5-footer.png" alt="Lỗi" /></a></div>
                  <div class="img-footer"><a href="#"><img src="img/img6-footer.png" alt="Lỗi" /></a></div>
                  <div class="img-footer"><a href="#"><img src="img/img7-footer.png" alt="Lỗi" /></a></div>
                </div> -->
              </div>
            </div>
          </div>
  ...
  <script>
    $(document).ready(function () {
      $("#notification-edit-click").click(function () {
        location.href="edit_be.php?id=<?php echo $item['id'];?>";
      });
    });
  </script>
</body>
