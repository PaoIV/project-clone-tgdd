    ...
    <div class="content" id="pay_content">
      <div class="pay_content">
        ...
        <div class ="pay_content_main">
          <div class="delivery_info_pay">
            <div id="user_name_pay">Cheo421</div>
            <div id="address_infor_pay"><input type="text"></div>
          </div>
          <br>
          <BR></BR>
          <div class="pro_info_pay">
            <div class="pro_info_pay_left">
              <div class="pro_info_pay_left_title">
                <h5>Sản Phẩm</h5>
                <br>
              </div>
              <div class="pro_info_pay_left_main">
                <div class="pro_info_pay_img">
                  <img src="img/img4-san-sale.jpg" alt="">
                </div>
                <div class="pro_info_pay_name">
                  IPhone 12 Pro Max 128GB
                </div>
              </div>
            </div>
            <div class="pro_info_pay_right">
              <div class="pro_info_unit_price">
                <div id="pro_info_title">
                  <h5>Đơn giá</h5>
                </div>
                <div id="unit_price">
                  <h5>22.000.000đ</h5>
          ...
          <div class="total_money">
            <div class="title"> <h5>Tổng số tiền:</h5></div>
            <div class ="money" ><h4> 22.000.000đ</h4></div>
          </div>
          <div class="bank_method">
            <h4>Phương thức thanh toán</h4>
              <div class ="bank_method_main">
                <div id="bank_method_choice">
                  <input name="Bank" type="radio" value="ViettinBank" /><img id="logo_vtb" src="img/vtblogo.png" alt="">ViettinBank  
                </div>
                <div id="bank_method_choice">
                  <input name="Bank" type="radio" value="MOMO" /><img id="logo_momo" src="img/logo_momo.png" alt=""> MOMO
                </div>
                <div id="bank_method_choice">
                  <input name="Bank" type="radio" value="Zalo Pay" /><img id="logo_zalo"src="img/logo_zalo.png" alt=""> Zalo Pay
              </div>
          </div>
          </div>
          <div class="btn_pay">
