...
<body>
  <div class="wrapper">
    ...
    <div class="content" id="manager_infor">
      <div class="info-content">
        <!-- <div class="travel-content-left">
          <form method="GET" action="search_be.php">
            <input id="input" name="q" value="<?php echo $q ?>"/>
            <button><i class="fas fa-search"></i></button>
          </form>
        </div>
      ...
      <div class ="info-content-main">
        <div class="info-content-left">
          ...
          <div class="name-infor">
            <h4>Nguyễn Thị Kim Anh</h4>
            <div class="password_change">
              <div id="icon">
                <a href="change_pass.php"><i class="fa-regular fa-pen-to-square" style="color: #ffffff;"></i></a>
              </div>
              <div id = "text">Đổi mật khẩu</div>
            </div>
            
          </div>
        </div>
        <div class="info-content-left1"></div>
          <h1></h1>
        <div class="info-content-mid">
          <div class="title-infor">
            <h3 id="title_infor">Hồ Sơ của tôi</h3>
            <h5 id="title_infor">Quản lý thông tin hồ sơ để bảo mật tài Khoản</h5>
          </div>
          <div class="infor_main">
            ...
            <div class = "info">
              ...
              <div class="info-input">
                <label>Nguyễn Thị Kim Anh</label>
              </div>
            </div>
            <div class = "info">
              <div class="info-title">
              ...
              <div class="info-input">
                <label>nguyenthikimanh04022001@gmail.com</label>
              </div>
            </div>
            <div class = "info">
              <div class="info-title">
        ...
        <div class="info-content-mid1"></div>
        <h1></h1>
  ...
  <div class="footer" id = "manager_infofooter">
