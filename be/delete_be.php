...
<body>
  <div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="travel-content-main-delete">
        <form class="form" action="delete_exec_be.php" method="post">
          <img src="<?php echo $result["img"]?>" alt="Lỗi"/>
          <div class="clear-both"></div>
          <input type="hidden" name="id" value="<?php echo $result["id"]?>"/>
          <label><b>Loại sản phẩm:</b> </label><label id="info_pro"><?php echo $result["cid"]?></label>
          <div class="clear-both"></div>
          <label><b>Tên sản phẩm:</b> </label><label id="info_pro"><?php echo $result["name"]?></label>
          <div class="clear-both"></div>
          <label><b>Giá:</b> </label><label id="info_pro"><?php echo $result["price_new"]?></label>
          <div class="clear-both"></div>
          <label><b>Mô tả: </b></label><label id="info_pro"><?php echo $result["description"]?></label>
          <div class="clear-both"></div>
          <label><b>Xuất xứ:  </b></label><label id="info_pro"><?php echo $result["source"]?></label>
          <div class="clear-both"></div>
          <button type="submit" class="btn btn-warning" id="btn_ctl_delete">Xóa</button>
          <a href="search_be.php"><button type="button" class="btn btn-warning" id="btn_ctl_delete">Bỏ qua</button></a>
        </form>
        <br/>
        <br/>
      </div>
