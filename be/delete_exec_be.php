<?php
  ...
  $q = isset($_REQUEST["q"]) ? $_REQUEST["q"] : '';
	...
	//print_r($_SESSION);
	$sql = "select * from chi_tiet {$cond} limit 10 ";
...
<body>
    ...
    <div class="notification-wrapper">
      <div class ="notification-main">
        <div class="notification-top">
          <span id = "notification-delete-click" class="btn-close-notifi" ><a href="#"><i class="fa-solid fa-square-xmark fa-lg" style="color: #ffc107;"></i></a></span>
        </div>
    ...
    <div class="header">
      ...
      <div class="header-footer">
        ...
        <div class="header-footer-responsive">
          ...
          <div id="box">
            <div><a href="chuyen_muc.php?id=10">
    ...
    <div class="content">
      ...
      <div class="travel-content">
        <div class="travel-content-left">
          <form method="GET" action="search_be.php">
            <input id="input" name="q" value=""/>
            <button><i class="fas fa-search"></i></button>
          </form>
        </div>
      ...
      <div class="travel-content-main">
        <?php foreach ($result as $item) {?>
          <div class="content-search-box">
            ...
            <p id="edit">
              <span class="btn_fix"><a href="edit_be.php?id=<?php echo $item['id'];?>">Sửa</a></span>
				      <span class="btn_delete"><a href="delete_be.php?id=<?php echo $item['id'];?>">Xóa</a></span>
            </p>
          </div>  
        <?php } ?>
      </div>
      <!-- end travel-content-main -->
    </div>
    <hr />
    <div class="footer">
      <div class="footer-main">
        ...
        <div class="footer-bottom">
          <p>© 2018. Công ty cổ phần Bige. GPDKKD: 0303217354 do sở KH & ĐT TP.HCM cấp ngày 02/01/2007.
  ...
  <script>
    $(document).ready(function () {
      ...
      $("#notification-delete-click").click(function () {
        location.href="search_be.php";
